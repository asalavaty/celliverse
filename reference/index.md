...
- [`ceLLMarkup()`](https://asalavaty.github.io/celliverse/reference/ceLLMarkup.md)
  : LLM-based cell-type annotation of clusters or marker sets
  (ceLLMarkup)
- [`clustoCell()`](https://asalavaty.github.io/celliverse/reference/clustoCell.md)
  : Clustering and marker discovery for single-cell data using
  EWCSR-based similarity
...
- [`markoClust()`](https://asalavaty.github.io/celliverse/reference/markoClust.md)
  : Evaluate and refine cell clusters using marker ranking and graph
  partitioning
