...
#'   transfer. Only applicable for \code{"ewcsr-red-cor"} and \code{"seurat-knn"}.
#'
...
clustoCell <- function(
  ...
  if(sketch) {
    ...
    if(!(label_transfer_method %in% c("seurat-knn", "seurat-project")) & !refine_transferred_subClusters) {
